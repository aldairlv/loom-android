...
fun NetworkTimelineObjectCarousel.asInternalCarouselEntity(): CarouselEntity {
...
fun NetworkTimelineObjectCarousel.asInternalCarouselItemEntities(): List<CarouselItemEntity> {
